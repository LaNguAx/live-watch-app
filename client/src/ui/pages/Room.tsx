      ...
      <div className="mx-auto max-w-screen-xl">
        <div className="grid grid-cols-1 gap-4 md:grid-cols-4 md:items-center md:gap-8">
          ...
          <div className="md:col-span-1 h-full flex flex-col gap-2">
            ...
            <article className="rounded-[10px] border border-gray-200 bg-white px-3 py-2 h-60 sm:h-80 overflow-y-auto">
            ...
            <div className="mt-auto space-y-2 text-xs">
              ...
              >
                ...
                <button
                  type="submit"
                  className="cursor-pointer w-full rounded-full bg-indigo-600 px-4 py-2 font-medium text-white hover:bg-indigo-700 transition"
                >
                  Send Message
                </button>
              </form>
              <button
                ...
                className="cursor-pointer w-full rounded-full border border-red-500 px-4 py-2 text-red-500 hover:bg-red-500 hover:text-white transition"
              >
                Leave Room
              </button>
            </div>
